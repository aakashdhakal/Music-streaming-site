...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
   ...
   <body style='margin:auto;padding:20px;border:2px dashed black;width:40%;color:black;'>
           <img src='https://raw.githubusercontent.com/aakashdhakal/BITBLOG/main/images/aakashdhakal.png' width='100px'>
           <section id='body' style='width: 83%; padding: 40px; font-family:Tahoma; margin: auto;'>
               ...
               <p style='font-size: 1rem; font-weight: 500; letter-spacing: 1px; line-height: 2;'>Welcome to A.D Family. Hope you had good time with us</p>
               <p style='font-size: 1rem; font-weight: 500; letter-spacing: 1px; line-height: 2;'>Thank you <br> The A.D Team</p>
           </section>
